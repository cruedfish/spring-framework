...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** Package-visible field for caching the resolved constructor or factory method.缓存构造方法或者工场方法 */
	@Nullable
	Executable resolvedConstructorOrFactoryMethod;

	/** Package-visible field that marks the constructor arguments as resolved. 标记字段，标记构造函数、参数已经解析了。默认为 `false`**/
	...
	/** Package-visible field for caching partly prepared constructor arguments.缓存构造函数参数 */
	@Nullable
